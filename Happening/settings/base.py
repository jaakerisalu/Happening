...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Happening] '  # subject prefix for managers & admins
...
# Email config
DEFAULT_FROM_EMAIL = "info@happening.swag"
SERVER_EMAIL = "server@happening.swag"
